...
describe('Insert', function() {
  ...
  () => {
    ...
    expect(trie.root.children.p.children.i.children.
          z.children.z.children.a.isCompleteWord).to.equal(true)
    expect(trie.root.children.p.children.i.children.
          z.children.z.isCompleteWord).to.equal(false)

    trie.insert("piz")

    expect(trie.root.children.p.children.i.children.
          z.isCompleteWord).to.equal(true)
